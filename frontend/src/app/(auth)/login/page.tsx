...
export default function LoginPage() {
  ...
  return (
    <>
      <h2 className="text-3xl font-extrabold text-t1-fixed mb-1.5">Welcome back</h2>
      <p className="text-t2-fixed text-base mb-8">Sign in to your Camparc workspace</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-xs font-bold text-t2-fixed uppercase tracking-wider">Password</label>
